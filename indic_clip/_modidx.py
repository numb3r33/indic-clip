  ...
  'syms': { 'indic_clip.core': { 'indic_clip.core.ensure_dir': ('core.html#ensure_dir', 'indic_clip/core.py'),
            ...
            'indic_clip.evaluation.metrics': { 'indic_clip.evaluation.metrics.calculate_retrieval_metrics': ( 'evaluation_metrics.html#calculate_retrieval_metrics',
                                               ...
                                               'indic_clip.evaluation.metrics.calculate_zeroshot_accuracy': ( 'evaluation_metrics.html#calculate_zeroshot_accuracy',
                                                                                                              'indic_clip/evaluation/metrics.py')},
            'indic_clip.learner': { 'indic_clip.learner.ContrastiveCallback': ('learner.html#contrastivecallback', 'indic_clip/learner.py'),
                                    'indic_clip.learner.ContrastiveCallback.__init__': ( 'learner.html#contrastivecallback.__init__',
                                                                                         'indic_clip/learner.py'),
                                    'indic_clip.learner.ContrastiveCallback.after_loss': ( 'learner.html#contrastivecallback.after_loss',
                                                                                           'indic_clip/learner.py'),
                                    'indic_clip.learner.ContrastiveCallback.after_pred': ( 'learner.html#contrastivecallback.after_pred',
                                                                                           'indic_clip/learner.py'),
                                    'indic_clip.learner.ContrastiveCallback.before_validate': ( 'learner.html#contrastivecallback.before_validate',
                                                                                                'indic_clip/learner.py'),
                                    'indic_clip.learner.RetrievalMetricCallback': ( 'learner.html#retrievalmetriccallback',
                                                                                    'indic_clip/learner.py'),
                                    ...
                                    'indic_clip.learner.RetrievalMetricCallback._gather_features': ( 'learner.html#retrievalmetriccallback._gather_features',
                                                                                                     'indic_clip/learner.py'),
                                    'indic_clip.learner.RetrievalMetricCallback.after_epoch': ( 'learner.html#retrievalmetriccallback.after_epoch',
                                                                                                'indic_clip/learner.py'),
